...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Dependencias entre migraciones';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Logs detallados de las migraciones';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `migration_logs` VALUES (4,5,'success','Sistema de migraciones creado exitosamente',NULL,'2025-07-08 22:52:22','finalization');
...
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Registro de migraciones de base de datos';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `migrations` VALUES (5,'001','Crear sistema de registro de migraciones','Creaci├│n inicial del sistema de control de versiones de base de datos con tablas migrations, migration_logs y migration_dependencies','create-migrations-table.sql',NULL,'completed',NULL,'2025-07-08 22:52:22','2025-07-08 22:52:22',NULL,'system',NULL,NULL,'[\"migrations\", \"migration_logs\", \"migration_dependencies\"]',NULL);
...
-- Dump completed on 2025-07-08 17:57:17
