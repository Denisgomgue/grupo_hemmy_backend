...
-- Primero, modificar el charset y collation de la base de datos
ALTER DATABASE `group_hemmy` CHARACTER SET = utf8mb4 COLLATE = utf8mb4_spanish2_ci;
...
CREATE TABLE `client` (
  ...
  `lastName` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish2_ci NOT NULL,
  `dni` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish2_ci NOT NULL,
  `phone` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish2_ci NOT NULL,
  `address` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish2_ci NOT NULL,
  `installationDate` datetime DEFAULT NULL,
  `reference` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish2_ci DEFAULT NULL,
  `paymentDate` datetime DEFAULT NULL,
  `advancePayment` tinyint DEFAULT NULL,
  `status` enum('ACTIVE','SUSPENDED','INACTIVE') CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish2_ci NOT NULL DEFAULT 'ACTIVE',
  ...
  `routerSerial` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish2_ci DEFAULT NULL,
  `decoSerial` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish2_ci DEFAULT NULL,
  `paymentStatus` enum('SUSPENDED','EXPIRING','EXPIRED','PAID') CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish2_ci NOT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `client` VALUES (1,'Mery Blanca','Chinchay Gomez','41663054','951376951','Carrtera Huantallon','2025-04-29 00:00:00','Antes de a plaza de armas','2025-05-29 00:00:00',1,'ACTIVE','Casa 3 pisos','2025-05-05 09:39:26.956751','2025-05-23 17:32:55.000000',2,2,NULL,NULL,'PAID'),(2,'Yuli Julissa','Rímac López','75524515','987780017','Calle la soledad s/n','2025-05-04 05:00:00','antes capilla','2025-06-05 05:00:00',1,'ACTIVE','','2025-05-05 11:59:42.113875','2025-05-23 17:34:05.000000',2,2,NULL,NULL,'PAID'),(3,'Miguel Angel','Regaldo Palma','74357705','948954927','Carretera Huaraz - Caraz ','2025-05-03 05:00:00','Antes del puente de Mullaca','2025-07-03 00:00:00',1,'ACTIVE','','2025-05-05 14:50:45.821721','2025-05-23 16:15:53.000000',2,3,NULL,NULL,'PAID'),(4,'Eberth Gabriel','Minaya Garcia','44825378','943900818','Carreterea Huaraz - Caraz','2025-05-03 05:00:00','Pasando 2do Puente - Uchuyacu','2025-06-03 05:00:00',1,'ACTIVE','FERRETERIA TECHO ROJO','2025-05-05 20:20:40.249991','2025-05-23 17:40:59.000000',2,4,NULL,NULL,'PAID'),(5,'Grescia ','Evangelina Salvador','60858237','991438074','Carretera San Miguel','2025-04-29 00:00:00','Segunda Curva','2025-05-28 00:00:00',0,'ACTIVE','','2025-05-05 20:26:42.541257','2025-05-23 17:40:15.000000',3,9,NULL,NULL,'EXPIRING'),(6,'Edinson ','Atoc Obregon','71926248','928028535','Jr. Miguel Grau ','2025-04-29 00:00:00','Una cuadra despues de la plaza','2025-05-28 00:00:00',1,'ACTIVE','','2025-05-05 20:30:56.269864','2025-05-23 17:39:27.000000',3,10,NULL,NULL,'PAID'),(7,'Lenin','Linares Leiva','75671429','938231126','Carretera Musho - Tumpa','2025-03-24 05:00:00','Frente a la Puerta Principal del Colegio Musho','2025-05-24 00:00:00',1,'ACTIVE','','2025-05-08 22:47:28.559995','2025-05-08 22:50:11.000000',3,10,'223C9H6002801','-','PAID'),(8,'Hiber Victor ','Alva Pachas','33342491','943499360','Av. Monterrey Nro. 4997','2025-01-09 05:00:00','Maderera rio santa','2025-02-09 05:00:00',0,'ACTIVE','','2025-05-09 14:17:06.679041','2025-05-09 14:17:06.679041',2,6,'48575443E82234AC','','SUSPENDED'),(9,'Flor ','Maguiña Ayala','45889852','910670128','Carrterera Huaraz - Caraz ','2025-03-15 05:00:00','Mullaca','2025-05-15 00:00:00',0,'ACTIVE','','2025-05-09 14:26:40.545883','2025-05-23 17:36:49.000000',2,3,'','','SUSPENDED'),(10,'Keyvin Justo','Minaya Picon','75261732','935224372','Primer entrada a Huantallon','2025-04-08 05:00:00','Casa Rustico','2025-07-07 00:00:00',0,'ACTIVE','','2025-05-09 14:32:25.642064','2025-05-09 14:49:54.000000',2,2,'','','PAID'),(11,'Alex Manuel ','Blas Colonia ','46262455','976732200','Carretera Huantallon','2025-04-22 00:00:00','Antes de Voltear a la Iglesia ','2025-06-21 00:00:00',1,'ACTIVE','','2025-05-09 14:44:18.073177','2025-05-09 14:47:52.000000',2,2,'09B192AA','','PAID'),(12,'Daniel Jesus ','Chavez Javier','44049492','978208097','Caserio Santa Rosa','2025-03-29 05:00:00','Primer Rompemuelle','2025-05-29 00:00:00',1,'ACTIVE','','2025-05-09 14:55:28.852989','2025-05-09 14:57:00.000000',2,5,'','','PAID'),(13,'Denis Patricia ','Cashpa Vega','47104542','924132661','Centro Poblado de Tumpa ','2025-03-10 00:00:00','Costado del Colegio de Tumpa','2025-06-08 00:00:00',0,'ACTIVE','','2025-05-09 18:58:36.544478','2025-05-09 19:02:51.000000',1,10,'','','PAID');
...
CREATE TABLE `payment` (
  ...
  `paymentDate` datetime DEFAULT NULL,
  `reference` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish2_ci DEFAULT NULL,
  `reconnection` tinyint NOT NULL,
  `amount` decimal(10,2) NOT NULL,
  `state` enum('PENDING','PAYMENT_DAILY','LATE_PAYMENT') CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish2_ci DEFAULT NULL,
  `paymentType` enum('TRANSFER','CASH','YAPE','PLIN','OTHER') CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish2_ci DEFAULT NULL,
  `transfername` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish2_ci DEFAULT NULL,
...
INSERT INTO `payment` VALUES (1,'2025-05-08 05:00:00','04181115',0,50.00,'LATE_PAYMENT','YAPE','Mily Hidalgo - 04181115',0.00,'2025-04-24 05:00:00','2025-05-08 22:50:11.348659','2025-05-08 22:50:11.348659',7),(2,'2025-05-09 05:00:00','04760728',0,50.00,'LATE_PAYMENT','TRANSFER','Grupo Hemmy EIRL',0.00,'2025-04-15 05:00:00','2025-05-09 14:28:07.934871','2025-05-09 14:28:07.934871',9),(4,'2025-05-09 05:00:00','04240636',0,50.00,'PAYMENT_DAILY','TRANSFER','GRUPO HEMMY EIRL',0.00,'2025-05-21 05:00:00','2025-05-09 14:47:52.198525','2025-05-09 14:47:52.198525',11),(5,'2025-05-09 05:00:00','09640137',0,50.00,'PAYMENT_DAILY','YAPE','MILY HIDALGO ROJAS',0.00,'2025-06-07 05:00:00','2025-05-09 14:49:54.503539','2025-05-09 14:49:54.503539',10),(6,'2025-05-09 05:00:00','03792646',0,50.00,'LATE_PAYMENT','YAPE','MILY HIDALGO ROJAS',0.00,'2025-04-29 05:00:00','2025-05-09 14:57:00.484139','2025-05-09 14:57:00.484139',12),(7,'2025-05-09 05:00:00','01368592',0,80.00,'LATE_PAYMENT','TRANSFER','GRUPO HEMMY EIRL',0.00,'2025-05-08 05:00:00','2025-05-09 19:02:02.841352','2025-05-09 19:02:51.000000',13);
...
CREATE TABLE `payment_history` (
  ...
  `dueDate` datetime DEFAULT NULL,
  `reference` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish2_ci DEFAULT NULL,
  `paymentType` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish2_ci DEFAULT NULL,
  `created_At` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6),
...
CREATE TABLE `permissions` (
  `id` int NOT NULL AUTO_INCREMENT,
  `name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish2_ci NOT NULL,
  `routeCode` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish2_ci NOT NULL,
  `actions` text CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish2_ci,
  `restrictions` text CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish2_ci,
  `isSubRoute` tinyint NOT NULL DEFAULT '0',
  `created_at` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6),
  `updated_at` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6),
  PRIMARY KEY (`id`)
...
CREATE TABLE `roles` (
  ...
  `name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish2_ci NOT NULL,
  `description` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish2_ci DEFAULT NULL,
  `allowAll` tinyint NOT NULL DEFAULT '0',
...
CREATE TABLE `service` (
  ...
  `name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish2_ci NOT NULL,
  `description` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish2_ci DEFAULT NULL,
  `status` enum('ACTIVE','INACTIVE') CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish2_ci NOT NULL,
  `created_at` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6),
  `update_at` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6),
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_spanish2_ci;
...
CREATE TABLE `user` (
  `id` int NOT NULL AUTO_INCREMENT,
  `name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish2_ci DEFAULT NULL,
  `surname` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish2_ci DEFAULT NULL,
  `documentType` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish2_ci NOT NULL,
  `documentNumber` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish2_ci NOT NULL,
  ...
  `password` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish2_ci DEFAULT NULL,
...
-- Dump completed on 2025-05-23 12:55:32
